package com.androhub.networkmodule.uc.swipeButton.iew;

import static com.androhub.networkmodule.uc.swipeButton.util.Dimension_Util.spToPx;
import static com.androhub.networkmodule.uc.swipeButton.util.Drawable_Color_Util.setDrawableColor;
import static com.androhub.networkmodule.uc.swipeButton.util.Drawable_Color_Util.setDrawableStroke;
...
import com.androhub.networkmodule.uc.swipeButton.controller.Swipe_Button_Controller;
...
public class Swipe_Button_View extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    private void getAttributes(TypedArray attributes) {
        ...
        ThumbImageId = attributes.getResourceId(R.styleable.SwipeButtonView_sb_thumb_image, R.drawable.ic_close_circle_red);
