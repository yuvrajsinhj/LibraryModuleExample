...
public class DottedProgressBar extends View {
    ...
    void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int defaultColor = r.getColor(R.color.btn_default);
        int defaultDotsCount = 12;
        int defaultMaxDotSize = 10;
        int defaultMinDotSize =3;
        int defaultArrowWidthSize = 7;
        int defaultArrowHourPadding = 28;
        int defaultArrowMinutePadding = 23;
        int defaultHourArrowSpeed = 5;
        int defaultMinuteArrowSpeed = 20;
        int defaultRotationSpeed = 6;
