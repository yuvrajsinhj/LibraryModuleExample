...
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.PageIndicatorView;
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.animation.type.AnimationType;
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.animation.type.BaseAnimation;
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.animation.type.ColorAnimation;
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.draw.controller.AttributeController;
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.draw.controller.DrawController;
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.draw.data.Orientation;
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.draw.data.RtlMode;
import com.androhub.networkmodule.utils.imageSlider.IndicatorView.utils.DensityUtils;
import com.androhub.networkmodule.utils.imageSlider.InfiniteAdapter.InfinitePagerAdapter;
import com.androhub.networkmodule.utils.imageSlider.Transformations.AntiClockSpinTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.Clock_SpinTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.CubeInDepthTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.CubeInRotationTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.CubeInScalingTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.CubeOutDepthTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.CubeOutRotationTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.CubeOutScalingTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.DepthTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.FadeTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.FanTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.FidgetSpinTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.GateTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.HingeTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.HorizontalFlipTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.PopTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.SimpleTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.SpinnerTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.TossTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.VerticalFlipTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.VerticalShutTransformation;
import com.androhub.networkmodule.utils.imageSlider.Transformations.ZoomOutTransformation;
...
public class SliderView extends FrameLayout
    ...
    public void enableDisableScroll(boolean isDisable){
        mSliderPager.enableDisableScroll(isDisable);
    }
    /**
    ...
    public void setIndicatorGravity(int gravity) {
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) mPagerIndicator.getLayoutParams();
    ...
    private int getAdapterItemsCount() {
        try {
            ...
            Utils.print(TAG, "getAdapterItemsCount: Slider Adapter is null so," +
    ...
    public void setViewHeight(Float height) {
        //clean callback
        ViewGroup.LayoutParams params = mSliderPager.getLayoutParams();
   ...
   /* public void stopSlideToNextPosition() {

        mSliderPager.setOnTouchListener(new OnTouchListener() {
